	...
	var $=function(id){
		...
		*/
		...
		new function(styleContent){
			...
			#NIE-topBar-menu.NIE-topBar-menu-hover{height:365px;opacity:.9;-webkit-transition:height .4s ease 0s;-o-transition:height .4s ease 0s;-moz-transition:height .4s ease 0s;transition:height .4s ease 0s;}\
		...
		');
		new function(){
            //2014.02.13为方便统计，加上了?from=nietop。因为考虑到效率问题，直接在html字符串里加入，不遍历加入。
